...
// Load credentials from config.js (loaded as global variable)
async function loadCredentials() {
    if (typeof SETUP_CONFIG !== 'undefined' && SETUP_CONFIG.setupCredentials) {
        return SETUP_CONFIG.setupCredentials;
    }
    console.error('SETUP_CONFIG not found or invalid');
    return null;
}
